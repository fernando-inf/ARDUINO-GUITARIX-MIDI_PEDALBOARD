...
/*OPCION 1*/            //for (int i = 0; i <=3; i++){if (ValBank == i) {digitalWrite(LED[i+7], HIGH);} else {digitalWrite(LED[i+7], LOW);}} ////Enciende LEDS Banco de a uno //Prende o apaga los LED de los Bancos segun haya quedado el estado de ValBank. Tanto MIDI OUT como MIDI IN cambian el estado de ValBank.
